...
Shader "BackgroundBlur"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( ( tex2D( _MainTex, appendResult21.xy ) + tex2D( _MainTex, appendResult30.xy ) + tex2D( _MainTex, uv_MainTex ) + tex2D( _MainTex, appendResult42.xy ) + tex2D( _MainTex, appendResult43.xy ) ) + ( tex2D( _MainTex, ( i.texcoord_0 + _Offset ) ) + tex2D( _MainTex, ( i.texcoord_0 - temp_cast_4 ) ) + tex2D( _MainTex, appendResult60.xy ) + tex2D( _MainTex, appendResult65.xy ) ) ) / 9.0 ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=13201
81;29;1633;1014;561.3547;-772.3983;1;True;False
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;73;222.4232,899.1412;Float;False;True;2;Float;ASEMaterialInspector;0;0;Unlit;BackgroundBlur;False;False;False;False;True;False;True;True;True;True;False;False;False;False;False;False;False;Back;0;0;False;0;0;Opaque;0.5;True;False;0;False;Opaque;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;False;0;4;10;25;False;0.5;False;0;Zero;Zero;0;Zero;Zero;Add;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;0;0;14;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;OBJECT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=76571447F5A9EB507F693A23AB3B8C80DEC60969